...
<%@ page import="com.learnjava.model.OrganizationSection" %>
<%@ page import="com.learnjava.util.HtmlUtil" %>
...
<section>
    <h1>${resume.fullName}&nbsp;<a href="resume?uuid=${resume.uuid}&action=edit"><img src="img/edit.svg"
                                                                                      alt="редактирование"></a></h1>
    <p>
        <c:forEach var="contactEntry" items="${resume.contacts}">
            <jsp:useBean id="contactEntry"
                         type="java.util.Map.Entry<com.learnjava.model.ContactType, java.lang.String>"/>
    ...
    <table>
        <c:forEach var="sectionEntry" items="${resume.sections}">
            ...
            <jsp:useBean id="section" type="com.learnjava.model.Section"/>
            <tr>
                ...
                <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>">
                        ...
                        <c:forEach var="position" items="${org.positions}">
                            <jsp:useBean id="position" type="com.learnjava.model.Period"/>
                            <tr>
